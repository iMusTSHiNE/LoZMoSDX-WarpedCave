...
-- Agahnim (Boss of WarpedDungeon1)

-- Possible positions where he appears.
local positions = {
  {x = 264, y = 152, direction4 = 3},
  {x = 144, y = 216, direction4 = 3},
  {x = 144, y = 280, direction4 = 3},
  {x = 384, y = 216, direction4 = 3},
  {x = 384, y = 280, direction4 = 3}
}
...
function enemy:escape()
  ...
  self:get_map():get_game():set_value("Ag1", true)
  self:remove()
end
