...
function enemy:on_created()
  ...
  self:set_attack_consequence_sprite(skeleton, "thrown_item", 1)
  self:set_attack_consequence_sprite(skeleton, "boomerang", 1)
end
...
function enemy:on_hurt(attack)
  ...
  if phase == 1 and self:get_life() <= 10 then
    self:stop_movement()
    ...
    self:set_attack_consequence_sprite(head, "thrown_item", 1)
