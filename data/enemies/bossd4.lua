...
-- Agahnim (alongside Dungeon 4 boss)

-- Possible positions where he appears.
local positions = {
  {x = 112, y = 320, direction4 = 3},
  {x = 200, y = 320, direction4 = 3},
  {x = 288, y = 320, direction4 = 3},
  {x = 112, y = 376, direction4 = 3},
  {x = 200, y = 376, direction4 = 3},
  {x = 288, y = 376, direction4 = 3},
  {x = 72, y = 384, direction4 = 3},
  {x = 328, y = 384, direction4 = 3},
  {x = 112, y = 472, direction4 = 3},
  {x = 200, y = 472, direction4 = 3},
  {x = 288, y = 472, direction4 = 3}
}
...
function enemy:escape()
  ...
  self:get_map():get_game():set_value("bossd4", true)
  self:remove()
end
