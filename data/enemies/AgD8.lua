...
-- Agahnim (alongside Billy in Dungeon 8)

-- Possible positions where he appears.
local positions = {
  {x = 1128, y = 88, direction4 = 3},
  {x = 1064, y = 128, direction4 = 3},
  {x = 1128, y = 128, direction4 = 3},
  {x = 1192, y = 128, direction4 = 3},
  {x = 1064, y = 184, direction4 = 3},
  {x = 1128, y = 184, direction4 = 3},
  {x = 1192, y = 184, direction4 = 3},
  {x = 1128, y = 224, direction4 = 3}
}
...
function enemy:escape()
  ...
  self:get_map():get_game():set_value("AgD8", true)
  self:remove()
end
