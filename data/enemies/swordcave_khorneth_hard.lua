...
-- State.
local left_blade_life = 8
local right_blade_life = 8
...
enemy:set_attack_consequence_sprite(left_blade_sprite, "thrown_item", "2")
enemy:set_attack_consequence_sprite(right_blade_sprite, "sword", "custom")
enemy:set_attack_consequence_sprite(right_blade_sprite, "thrown_item", "2")
