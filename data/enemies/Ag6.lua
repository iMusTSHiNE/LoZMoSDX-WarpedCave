...
-- Agahnim (before Dungeon5)

-- Possible positions where he appears.
local positions = {
  {x = 96, y = 200, direction4 = 3},
  {x = 96, y = 152, direction4 = 3},
  {x = 96, y = 112, direction4 = 3},
  {x = 136, y = 152, direction4 = 3},
  {x = 136, y = 112, direction4 = 3},
  {x = 176, y = 200, direction4 = 3},
  {x = 176, y = 152, direction4 = 3},
  {x = 176, y = 112, direction4 = 3},
  {x = 352, y = 200, direction4 = 3},
  {x = 352, y = 152, direction4 = 3},
  {x = 352, y = 112, direction4 = 3},
  {x = 392, y = 200, direction4 = 3},
  {x = 392, y = 152, direction4 = 3},
  {x = 392, y = 112, direction4 = 3},
  {x = 432, y = 200, direction4 = 3},
  {x = 432, y = 152, direction4 = 3},
  {x = 432, y = 112, direction4 = 3},
  {x = 608, y = 200, direction4 = 3},
  {x = 608, y = 152, direction4 = 3},
  {x = 608, y = 112, direction4 = 3},
  {x = 648, y = 200, direction4 = 3},
  {x = 648, y = 152, direction4 = 3},
  {x = 648, y = 112, direction4 = 3},
  {x = 688, y = 200, direction4 = 3},
  {x = 688, y = 152, direction4 = 3},
  {x = 688, y = 112, direction4 = 3}
}

local nb_sons_created = 0
local initial_life = 15
...
function enemy:escape()
  ...
  self:get_map():get_game():set_value("Ag6", true)
  self:remove()
end
