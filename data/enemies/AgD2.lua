...
local positions = {
  {x = 856, y = 552, direction4 = 3},
  {x = 752, y = 552, direction4 = 3},
  {x = 960, y = 552, direction4 = 3},
  {x = 856, y = 504, direction4 = 3},
  {x = 752, y = 504, direction4 = 3},
  {x = 960, y = 504, direction4 = 3},
  {x = 856, y = 400, direction4 = 3},
  {x = 1024, y = 640, direction4 = 3},
  {x = 688, y = 640, direction4 = 3}
}
...
function enemy:escape()
  ...
  self:get_map():create_pickable{
    treasure_name = "bow",
    treasure_variant = 1,
    treasure_savegame_variable = "bow",
    x = x,
    y = y,
    layer = 0
  }
  self:get_map():get_entity("hero"):unfreeze()
  self:get_map():get_game():set_value("AgD2", true)
  self:remove()
end
