...
-- Agahnim (Sword Cave B3 second fight)

-- Possible positions where he appears.
local positions = {
  {x = 840, y = 328, direction4 = 3},
  {x = 888, y = 328, direction4 = 3},
  {x = 936, y = 328, direction4 = 3},
  {x = 840, y = 392, direction4 = 3},
  {x = 888, y = 392, direction4 = 3},
  {x = 936, y = 392, direction4 = 3},
  {x = 840, y = 456, direction4 = 3},
  {x = 888, y = 456, direction4 = 3},
  {x = 936, y = 456, direction4 = 3},
  {x = 840, y = 520, direction4 = 3},
  {x = 888, y = 520, direction4 = 3},
  {x = 936, y = 520, direction4 = 3},
  {x = 840, y = 584, direction4 = 3},
  {x = 888, y = 584, direction4 = 3},
  {x = 936, y = 584, direction4 = 3},
  {x = 840, y = 656, direction4 = 3},
  {x = 888, y = 656, direction4 = 3},
  {x = 936, y = 656, direction4 = 3}
}
...
function enemy:fire_step_3()
  ...
  if sprite:get_animation() == "preparing_blue_fireball" then
    ...
    sound = "boss_fireball"
    breed = "swordcave_red_fireball_triple_b"
  end
  sprite:set_animation("stopped")
