...
-- Agahnim (Sword Cave B3 first fight)

-- Possible positions where he appears.
local positions = {
  {x = 72, y = 88, direction4 = 3},
  {x = 120, y = 88, direction4 = 3},
  {x = 168, y = 88, direction4 = 3},
  {x = 216, y = 88, direction4 = 3},
  {x = 264, y = 88, direction4 = 3},
  {x = 312, y = 88, direction4 = 3},
  {x = 360, y = 88, direction4 = 3},
  {x = 72, y = 136, direction4 = 3},
  {x = 120, y = 136, direction4 = 3},
  {x = 168, y = 136, direction4 = 3},
  {x = 216, y = 136, direction4 = 3},
  {x = 264, y = 136, direction4 = 3},
  {x = 312, y = 136, direction4 = 3},
  {x = 360, y = 136, direction4 = 3},
  {x = 72, y = 184, direction4 = 3},
  {x = 120, y = 184, direction4 = 3},
  {x = 168, y = 184, direction4 = 3},
  {x = 216, y = 184, direction4 = 3},
  {x = 264, y = 184, direction4 = 3},
  {x = 312, y = 184, direction4 = 3},
  {x = 360, y = 184, direction4 = 3}
}
...
function enemy:fire_step_3()
  ...
  if sprite:get_animation() == "preparing_blue_fireball" then
    ...
    sound = "boss_fireball"
    breed = "swordcave_agahnim_red_fireball_triple_hard"
  end
  sprite:set_animation("stopped")
