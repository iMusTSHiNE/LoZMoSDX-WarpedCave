...
-- Fake Agahnim (with Agahnim V2 of Dungeon 10 B1).

-- Possible positions where he appears.
local positions = {
  {x = 592, y = 96, direction4 = 3},
  {x = 656, y = 96, direction4 = 3},
  {x = 720, y = 96, direction4 = 3},
  {x = 592, y = 160, direction4 = 3},
  {x = 592, y = 240, direction4 = 3},
  {x = 656, y = 240, direction4 = 3},
  {x = 720, y = 240, direction4 = 3}
}
