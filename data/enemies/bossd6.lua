...
-- Agahnim (alongside Dungeon6 Boss)

-- Possible positions where he appears.
local positions = {
  {x = 152, y = 240, direction4 = 3},
  {x = 392, y = 240, direction4 = 3},
  {x = 152, y = 280, direction4 = 3},
  {x = 392, y = 280, direction4 = 3},
  {x = 224, y = 240, direction4 = 3},
  {x = 328, y = 240, direction4 = 3},
  {x = 272, y = 320, direction4 = 3},
  {x = 152, y = 360, direction4 = 3},
  {x = 392, y = 360, direction4 = 3}
}
...
function enemy:escape()
  ...
  self:get_map():get_game():set_value("bossd6", true)
  self:remove()
end
