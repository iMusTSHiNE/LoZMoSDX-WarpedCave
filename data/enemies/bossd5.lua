...
-- Agahnim (Boss alongside boss of Dungeon 5)
...
local positions = {
  ...
  {x = 224, y = 296, direction4 = 3},
  {x = 368, y = 296, direction4 = 3},
  {x = 296, y = 344, direction4 = 1}
}
...
function enemy:escape()
  ...
  self:get_map():get_game():set_value("bossd5", true)
  self:remove()
end
