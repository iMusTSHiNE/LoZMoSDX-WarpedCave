...
local positions = {
  {x = 256, y = 552, direction4 = 3},
  {x = 184, y = 536, direction4 = 3},
  {x = 336, y = 536, direction4 = 3},
  {x = 256, y = 616, direction4 = 3},
  {x = 256, y = 688, direction4 = 3},
  {x = 256, y = 792, direction4 = 3},
  {x = 104, y = 680, direction4 = 3},
  {x = 168, y = 680, direction4 = 3},
  {x = 344, y = 680, direction4 = 3},
  {x = 408, y = 680, direction4 = 3}
}
...
function enemy:escape()
  ...
  self:get_map():create_pickable{
    treasure_name = "flippers",
    treasure_variant = 1,
    treasure_savegame_variable = "flippers",
    x = x,
    y = y,
    layer = 0
  }
  self:get_map():get_entity("hero"):unfreeze()
  self:get_map():get_game():set_value("Ag3", true)
  self:remove()
end
