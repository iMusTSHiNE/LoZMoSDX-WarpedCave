...
function map:on_started(destination)
  ...
  if door_d_enemy ~= nil then
    ...
    door_d_enemy_2:set_enabled(false)
    door_d_enemy_3:set_enabled(false)
    door_b_enemy_3:set_enabled(false)
  end
end
...
function close_door_b_sensor_1:on_activated()
  ...
  if door_b:is_open()
    ...
    door_b_enemy_3:set_enabled(true)
  end
end
...
function close_door_d_sensor:on_activated()
  ...
  if door_d:is_open()
    ...
    door_d_enemy_2:set_enabled(true)
    door_d_enemy_3:set_enabled(true)
  end
end
...
door_b_enemy_3.on_dead = door_b_enemy_1.on_dead
...
door_c_enemy_3.on_dead = door_c_enemy_1.on_dead
